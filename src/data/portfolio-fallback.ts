...
import { buildLablogFallbackPosts } from './lablog-fallback'
...
export const portfolioFallback = {
  ...
  seoDefaults: {
    ...
    ogImage: null,
    titleTemplate: '%s | Bertrand Fouquet',
    keywords:
      'portfolio, web designer, développeur web, La Rochelle, UX, UI, WordPress, Next.js',
    ogLocale: 'fr_FR',
    ogSiteName: 'Bertrand Fouquet',
